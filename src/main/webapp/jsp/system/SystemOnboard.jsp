...
$(document).ready(function() {
	$("#system_region").change(function() {
	      ...
	      if(region!='') {
	        $.ajax({ 
	          type: "POST",
	          url: "${pageContext.request.contextPath}/system/FetchCountriesForRegion",
	          data: {region: region},
	          cache: false,
	...
	$("#system_eim").keyup(function() {
	      ...
	      if(eim!='') {
	        $.ajax({ 
	          type: "POST",
	          url: "${pageContext.request.contextPath}/system/EIMValidation",
	          data: {eim: eim},
	          cache: false,
	          success: function(html) {
	        	  $("#validate").html(html);
				...
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" id="SystemOnboard" name="SystemOnboard"
							method="POST" action="${pageContext.request.contextPath}/system/register"
