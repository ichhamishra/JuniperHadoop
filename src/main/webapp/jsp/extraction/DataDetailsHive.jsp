				...
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" id="DataDetails" name="DataDetails"
							method="POST"
							action="${pageContext.request.contextPath}/extraction/DataDetailsHive1"
							...
							<div class="form-group">
									<label>Hive Query *</label> <textarea rows="5"
										class="form-control" id="hive_query" name="hive_query">
										 </textarea>
								</div>
