					...
					<div class="card-body">
						...
						<script type="text/javascript">
							window.onload = function() {
									document.getElementById("host_name").value = "192.168.43.68";
									document.getElementById("port").value = "1025";
									document.getElementById("user_name").value = "dbc";
									document.getElementById("password").value = "dbc";
									document.getElementById("db_name").value = "arg_loans_db";
