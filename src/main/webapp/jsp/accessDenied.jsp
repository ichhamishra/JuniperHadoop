                    ...
                    <div class="img-wrapper">
                        ...
                        <div class="overlay">
                            <div class="buttons" align="center">
                                <a rel="gallery" class="fancybox" href="${pageContext.request.contextPath}/hip">HIP Run Statistics</a>
                                <a rel="gallery" class="fancybox" href="${pageContext.request.contextPath}/hipmaster">HIP Master Data</a>
                            </div>
                        </div>
                    </div>
                    <figcaption>
            ...
            <div class="col-sm-4 col-xs-12">
                <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="300ms">
                    <div class="img-wrapper">
                        ...
                        <div class="overlay">
                            <div class="buttons">
                                <a rel="gallery" class="fancybox" href="${pageContext.request.contextPath}/register">Register Feed</a>
                                <!--<a target="_blank" href="single-portfolio.html">Details</a>-->
                            </div>
                        </div>
                    </div>
